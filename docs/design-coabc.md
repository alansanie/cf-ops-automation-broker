...
- encountered problems
    ...
    - route registrar 
        curl -X GET https://cassandra-brokerc.nd-preprod-ops-paas.itn.intraorange:443/v2/catalog
        404 Not Found: Requested route ('cassandra-brokerc.nd-preprod-ops-paas.itn.intraorange') does not exist.
    =>To be investigated       
